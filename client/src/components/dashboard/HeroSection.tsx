    ...
    >
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="mt-20 text-center">
          <p className="text-black/80 text-sm mb-8 font-medium">
          ...
          <LogoLoop className="opacity-60" speed="slow">
            ...
            <div className="text-black/60 font-bold text-lg italic px-8">
              AirAsia
            </div>
            <div className="text-black/60 font-bold text-lg px-8">
              AIR INDIA
            </div>
