        ...
        >
          ...
          <div className="flex items-center justify-between p-4 border-b border-rose-200 bg-white/80 backdrop-blur rounded-t-2xl">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-gray-800 font-medium text-sm">Bus Booking AI</h3>
                <p className="text-gray-500 text-xs">Ask, search, or make anything...</p>
              </div>
            </div>
                      ...
                      {message.suggestions && (
                        <div className="mt-3 space-y-2">
                          {message.suggestions.map((suggestion, index) => (
                            ...
                            >
                              {index === 0 && <Sparkles className="w-3 h-3 text-yellow-500" />}
                              {index === 1 && <Globe className="w-3 h-3 text-blue-500" />}
                              {index === 2 && <Search className="w-3 h-3 text-green-500" />}
                              {index === 3 && <CheckCircle className="w-3 h-3 text-purple-500" />}
                              <span className="text-gray-700">{suggestion}</span>
                              {index === 0 && <span className="ml-auto text-pink-500 text-xs">New</span>}
                              {index === 2 && <span className="ml-auto text-green-500 text-xs">New</span>}
                              {index === 3 && <span className="ml-auto text-purple-500 text-xs">New</span>}
                            </button>
                          ))}
                        </div>
                      )}
