...
import { type QueryTripRouteParams, type TripRouteResponse } from "@/store/type/tripRoutesType";
...
export const routesApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getTripRouteMap: builder.query<TripRouteResponse["data"], QueryTripRouteParams>({
      query: (params) => {
