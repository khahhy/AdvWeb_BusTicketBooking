...
export class ETicketService {
  ...
  async generatePDF(ticketCode: string): Promise<Buffer> {
    ...
    return new Promise((resolve, reject) => {
      ...
      doc.moveTo(margin, 175).lineTo(pageWidth - margin, 175).dash(8, { space: 4 }).stroke();
      doc.undash();
      ...
      doc.moveTo(margin + 15, payY + 25).lineTo(pageWidth - margin - 15, payY + 25).stroke();
      ...
      // QR Code instruction
      doc.fillColor('#6b7280').fontSize(9).font('Helvetica');
      doc.text('Scan this QR code for quick verification', margin + 110, y + 40, { width: 150 });
      ...
      const bulletY = y + 30;
      doc.text('• Please arrive at the terminal at least 15 minutes before departure', margin + 15, bulletY);
      doc.text('• Bring a valid ID matching the passenger name on this ticket', margin + 15, bulletY + 14);
      doc.text('• Present this e-ticket (printed or digital) for boarding', margin + 15, bulletY + 28);
      doc.text('• Keep your booking code safe for any inquiries', margin + 15, bulletY + 42);
      ...
      doc.fillColor('#6b7280').fontSize(10).font('Helvetica');
      doc.text('Thank you for choosing Bus Ticket Booking Service', margin, footerY + 12, { align: 'center', width: contentWidth });
      doc.fillColor('#9ca3af').fontSize(8);
      doc.text('For support: support@busticket.com | Hotline: 1900-xxxx', margin, footerY + 28, { align: 'center', width: contentWidth });
